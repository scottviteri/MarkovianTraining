...
# 1. a function that takes a message and a batch of data and returns a batch of messages with the data prepended
# 2. the expected length of the transformed tokens
# 3. the name
...
def main():
    ...
    dataset_1_loader = torch.utils.data.DataLoader(reshaped_tensor, batch_size=8, shuffle=True)
    ...
    for experiment in experiments:
        losses = run_experiment(experiment, dataset_1_loader, causal_lm, loss_fn, device)
