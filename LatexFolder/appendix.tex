...
All experiments maintained consistent core hyperparameters: learning rate (1e-4), KL penalty (0.1), reward mixing parameter r (0.9), and LoRA configuration (rank 8, alpha 16). The CoT length was fixed at 75 tokens to ensure consistent computational overhead across experiments. Detailed model and dataset specifications are provided in the Reproducibility Statement below.
